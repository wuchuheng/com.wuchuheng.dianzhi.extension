...
/**
 * Applies the same committed height delta to scrollTop when the viewport was
 * strictly inside the 150px guard before that growth was committed.
 */
...
/**
 * Keeps the Side Panel pinned while it is inside the 150px bottom guard.
 * Streaming height and scrollTop move by the same delta in the same committed
 * frame, avoiding a second animation controller chasing stale scrollHeight.
 */
